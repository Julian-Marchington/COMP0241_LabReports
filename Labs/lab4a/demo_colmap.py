...
def run():
    ...
    sift_extraction_options.num_threads = 10
    sift_extraction_options.max_image_size = 1080
    sift_extraction_options.max_num_features = 33000  # Increased to detect more features
    ...
    print(f"Processing time for {sift_extraction_options.max_num_features} features: {processing_time:.2f} seconds")
